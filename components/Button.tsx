...
export default function Button({ onClick, size, children }: Props) {
    return size === "lg" ? <div className="h-12 w-80 border-green border-solid border-2 rounded-3xl align-middle hover:bg-green hover:cursor-pointer group" onClick={e => onClick()}>
