...
export default function Page() {
    ...
    return <div className="h-screen bg-dark-gray font-lato">
        <div className="mx-auto w-3/4">
            ...
            <div className="lg:w-96 text-center mx-auto mt-8">
                <p className="text-white lg:text-xl">Discover all of the collaborations between your favorite artist on Spotify.</p>
            </div>
            <div className={`text-center mt-16 ${mobile ? "w-64": "w-80"} mx-auto`}>
                <Button onClick={handleLogin} size="lg" mobile={mobile}>Log In With Spotify</Button>
            </div>
        </div>
    </div>;
}